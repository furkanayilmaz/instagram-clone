...
const postFooterIcons = [
    ...
    {
        name: 'Share',
        imageUrl: 'https://img.icons8.com/external-flatart-icons-outline-flatarticons/60/ffffff/external-send-email-flatart-icons-outline-flatarticons.png'
    },
    {
        name: 'Save',
...
const Likes = ({ post }) => (
    <View style={{ flexDirection: "row", marginTop: 4 }}>
        <Text style={{ color: 'white', fontWeight: "600" }}>{post.likes_by_users.toLocaleString('en')}0 likes</Text> 
        {/* 5:33:07 */}
    </View>
)
